...
## Create ECR Repo and push frontend and backend
### Login to ECR
...
--build-arg REACT_APP_CLIENT_ID="6b6ro31g97jrk767adrbrdj1g5" \
-t frontend-react-js \
-f Dockerfile.prod \
.
```
...
### Passing Senstive Data to Task Defintion using Parameter store
Reference Links
...
## Deploy application as a service to Fargate
### Create Services
