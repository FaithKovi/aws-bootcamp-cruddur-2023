...
Using the AWS Console we'll create a Cognito User Pool
Proof of user pool created
![Proof](assets/userpool-created.PNG)
...
{errors}
```
Proof of Signin Page working
![Proof](assets/sign-in1.PNG)
